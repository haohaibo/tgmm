...
const double Wishartdev::constant2 =
    0.25 * dimsImage * (dimsImage - 1) * log(Wishartdev::Pi);
...
void Wishartdev::testWishart(string outFile) {
  ...
  Wishartdev *wishartCDF =
      new Wishartdev(nu_k, lambda, seed++);  // bogus initialization
