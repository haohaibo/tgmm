...
SWC_Node *Add_Vertex_As_Root(SWC_Tree *tree, SWC_Kind kind, double x, double y,
                             double z, double r);

SWC_Node *Add_Vertex_As_First_Child(SWC_Tree *tree, SWC_Node *v, SWC_Kind kind,
                                    double x, double y, double z, double r);

SWC_Node *Add_Vertex_As_Sibling(SWC_Tree *tree, SWC_Node *v, SWC_Kind kind,
                                double x, double y, double z, double r);

SWC_Node *Add_Vertex_As_Father(SWC_Tree *tree, SWC_Node *v, SWC_Kind kind,
                               double x, double y, double z, double r);

SWC_Bundle *Clip_SWC_Tree(SWC_Bundle *R(G(forest)), SWC_Tree *tree,
                          Double_Vector *F(beg), Double_Vector *F(end));
