...
Minimum_Bundle *Find_Min_Bracket(Minimum_Bundle *R(M(brack)), double xin,
                                 double step, double (*f)(double));

double Minimize_Fct(Minimum_Bundle *brack, double (*f)(double),
                    double (*df)(double));

Double_Vector *Powell_Minimizer(Double_Vector *R(M(xinit)), double step,
                                double (*f)(double *));
