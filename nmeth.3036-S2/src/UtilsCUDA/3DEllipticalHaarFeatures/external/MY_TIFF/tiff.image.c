...
typedef struct __Tiff_Histogram
  { struct __Tiff_Histogram *next;
    struct __Tiff_Histogram *prev;
    int                      refcnt;
    Tiff_Histogram           tiff_histogram;
  } _Tiff_Histogram;

static _Tiff_Histogram *Free_Tiff_Histogram_List = NULL;
static _Tiff_Histogram *Use_Tiff_Histogram_List  = NULL;

static pthread_mutex_t Tiff_Histogram_Mutex = PTHREAD_MUTEX_INITIALIZER;

static int Tiff_Histogram_Offset = sizeof(_Tiff_Histogram)-sizeof(Tiff_Histogram);
static int Tiff_Histogram_Inuse  = 0;

int Tiff_Histogram_Refcount(Tiff_Histogram *tiff_histogram)
...
{ _Tiff_Histogram *object;
  ...
  pthread_mutex_lock(&Tiff_Histogram_Mutex);
  if (Free_Tiff_Histogram_List == NULL)
    { object = (_Tiff_Histogram *) Guarded_Realloc(NULL,sizeof(_Tiff_Histogram),routine);
      if (object == NULL) return (NULL);
      tiff_histogram = &(object->tiff_histogram);
    }
  else
  ...
  object->refcnt = 1;
  if (Use_Tiff_Histogram_List != NULL)
    Use_Tiff_Histogram_List->prev = object;
  object->next = Use_Tiff_Histogram_List;
  object->prev = NULL;
  Use_Tiff_Histogram_List = object;
  pthread_mutex_unlock(&Tiff_Histogram_Mutex);
  return (tiff_histogram);
}
...
{ return ((Tiff_Histogram *) copy_tiff_histogram(tiff_histogram)); }

Tiff_Histogram *Pack_Tiff_Histogram(Tiff_Histogram *tiff_histogram)
{ return (tiff_histogram); }

Tiff_Histogram *Inc_Tiff_Histogram(Tiff_Histogram *tiff_histogram)
{ _Tiff_Histogram *object  = (_Tiff_Histogram *) (((char *) tiff_histogram) - Tiff_Histogram_Offset);
  pthread_mutex_lock(&Tiff_Histogram_Mutex);
  object->refcnt += 1;
  pthread_mutex_unlock(&Tiff_Histogram_Mutex);
...
{ _Tiff_Histogram *object  = (_Tiff_Histogram *) (((char *) tiff_histogram) - Tiff_Histogram_Offset);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Freeing previously released Tiff_Histogram\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Tiff_Histogram_List = object->next;
  if (object->next != NULL)
...
{ _Tiff_Histogram *object  = (_Tiff_Histogram *) (((char *) tiff_histogram) - Tiff_Histogram_Offset);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Killing previously released Tiff_Histogram\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Tiff_Histogram_List = object->next;
...
{ _Tiff_Histogram *a, *b;
  for (a = Use_Tiff_Histogram_List; a != NULL; a = b)
    { b = a->next;
      handler((Tiff_Histogram *) &(a->tiff_histogram));
    }
}
...
typedef struct __Tiff_Channel
  { struct __Tiff_Channel *next;
    struct __Tiff_Channel *prev;
    int                    refcnt;
    Tiff_Channel           tiff_channel;
  } _Tiff_Channel;

static _Tiff_Channel *Free_Tiff_Channel_List = NULL;
static _Tiff_Channel *Use_Tiff_Channel_List  = NULL;

static pthread_mutex_t Tiff_Channel_Mutex = PTHREAD_MUTEX_INITIALIZER;

static int Tiff_Channel_Offset = sizeof(_Tiff_Channel)-sizeof(Tiff_Channel);
static int Tiff_Channel_Inuse  = 0;

int Tiff_Channel_Refcount(Tiff_Channel *tiff_channel)
...
static inline Tiff_Channel *new_tiff_channel(char *routine)
{ _Tiff_Channel *object;
  Tiff_Channel  *tiff_channel;

  pthread_mutex_lock(&Tiff_Channel_Mutex);
  if (Free_Tiff_Channel_List == NULL)
    { object = (_Tiff_Channel *) Guarded_Realloc(NULL,sizeof(_Tiff_Channel),routine);
      if (object == NULL) return (NULL);
      tiff_channel = &(object->tiff_channel);
    }
  else
  ...
  object->refcnt = 1;
  if (Use_Tiff_Channel_List != NULL)
    Use_Tiff_Channel_List->prev = object;
  object->next = Use_Tiff_Channel_List;
  object->prev = NULL;
  Use_Tiff_Channel_List = object;
  pthread_mutex_unlock(&Tiff_Channel_Mutex);
  tiff_channel->histogram = NULL;
  return (tiff_channel);
}

static inline Tiff_Channel *copy_tiff_channel(Tiff_Channel *tiff_channel)
{ Tiff_Channel *copy = new_tiff_channel("Copy_Tiff_Channel");
  *copy = *tiff_channel;
  if (tiff_channel->histogram != NULL)
    copy->histogram = Copy_Tiff_Histogram(tiff_channel->histogram);
  return (copy);
}

Tiff_Channel *Copy_Tiff_Channel(Tiff_Channel *tiff_channel)
{ return ((Tiff_Channel *) copy_tiff_channel(tiff_channel)); }

static inline int pack_tiff_channel(Tiff_Channel *tiff_channel)
{
  if (tiff_channel->histogram != NULL)
    if (Pack_Tiff_Histogram(tiff_channel->histogram) == NULL) return (1);
  return (0);
}

Tiff_Channel *Pack_Tiff_Channel(Tiff_Channel *tiff_channel)
{ if (pack_tiff_channel(tiff_channel)) return (NULL);
  return (tiff_channel);
}

Tiff_Channel *Inc_Tiff_Channel(Tiff_Channel *tiff_channel)
{ _Tiff_Channel *object  = (_Tiff_Channel *) (((char *) tiff_channel) - Tiff_Channel_Offset);
  pthread_mutex_lock(&Tiff_Channel_Mutex);
  object->refcnt += 1;
  pthread_mutex_unlock(&Tiff_Channel_Mutex);
...
{ _Tiff_Channel *object  = (_Tiff_Channel *) (((char *) tiff_channel) - Tiff_Channel_Offset);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Freeing previously released Tiff_Channel\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Tiff_Channel_List = object->next;
  if (object->next != NULL)
    object->next->prev = object->prev;
...
{ _Tiff_Channel *object  = (_Tiff_Channel *) (((char *) tiff_channel) - Tiff_Channel_Offset);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Killing previously released Tiff_Channel\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Tiff_Channel_List = object->next;
...
{ _Tiff_Channel *a, *b;
  for (a = Use_Tiff_Channel_List; a != NULL; a = b)
    { b = a->next;
      handler((Tiff_Channel *) &(a->tiff_channel));
    }
}
...
typedef struct __Timage
  { struct __Timage *next;
    struct __Timage *prev;
    int              refcnt;
    int              csize;
    int              msize;
    Timage           timage;
...
static _Timage *Free_Timage_List = NULL;
static _Timage *Use_Timage_List  = NULL;

static pthread_mutex_t Timage_Mutex = PTHREAD_MUTEX_INITIALIZER;

static int Timage_Offset = sizeof(_Timage)-sizeof(Timage);
static int Timage_Inuse  = 0;

int Tiff_Image_Refcount(Tiff_Image *tiff_image)
{ _Timage *object = (_Timage *) (((char *) tiff_image) - Timage_Offset);
  return (object->refcnt);
}

static inline int allocate_timage_channels(Timage *timage, int csize, char *routine)
{ _Timage *object = (_Timage *) (((char *) timage) - Timage_Offset);
  if (object->csize < csize)
    { void *x = Guarded_Realloc(timage->channels,(size_t) csize,routine);
      if (x == NULL) return (1);
      timage->channels = x;
      object->csize = csize;
    }
...
static inline int sizeof_timage_channels(Timage *timage)
{ _Timage *object = (_Timage *) (((char *) timage) - Timage_Offset);
  return (object->csize);
}

static inline int allocate_timage_map(Timage *timage, int msize, char *routine)
{ _Timage *object = (_Timage *) (((char *) timage) - Timage_Offset);
  if (object->msize < msize)
    { void *x = Guarded_Realloc(timage->map,(size_t) msize,routine);
      if (x == NULL) return (1);
      timage->map = x;
      object->msize = msize;
    }
...
static inline int sizeof_timage_map(Timage *timage)
{ _Timage *object = (_Timage *) (((char *) timage) - Timage_Offset);
  return (object->msize);
}

static inline void kill_timage(Timage *timage);

static inline Timage *new_timage(int csize, int msize, char *routine)
{ _Timage *object;
  Timage  *timage;

  pthread_mutex_lock(&Timage_Mutex);
  if (Free_Timage_List == NULL)
    { object = (_Timage *) Guarded_Realloc(NULL,sizeof(_Timage),routine);
      if (object == NULL) return (NULL);
      timage = &(object->timage);
      object->csize = 0;
      timage->channels = NULL;
      object->msize = 0;
      timage->map = NULL;
    }
  else
    { object = Free_Timage_List;
      Free_Timage_List = object->next;
      timage = &(object->timage);
    }
  Timage_Inuse += 1;
  object->refcnt = 1;
  if (Use_Timage_List != NULL)
    Use_Timage_List->prev = object;
  object->next = Use_Timage_List;
  object->prev = NULL;
  Use_Timage_List = object;
  pthread_mutex_unlock(&Timage_Mutex);
  timage->ifd_ref = NULL;
  if (allocate_timage_channels(timage,csize,routine))
    { kill_timage(timage);
      return (NULL);
    }
  if (allocate_timage_map(timage,msize,routine))
    { kill_timage(timage);
      return (NULL);
    }
  return (timage);
...
static inline Timage *copy_timage(Timage *timage)
{ Timage *copy = new_timage(timage_csize(timage),timage_msize(timage),"Copy_Tiff_Image");
  void *_channels = copy->channels;
  void *_map = copy->map;
  *copy = *timage;
  copy->channels = _channels;
  if (timage->channels != NULL)
    memcpy(copy->channels,timage->channels,(size_t) timage_csize(timage));
  copy->map = _map;
  if (timage->map != NULL)
    memcpy(copy->map,timage->map,(size_t) timage_msize(timage));
  if (timage->ifd_ref != NULL)
    Inc_Tiff_IFD(timage->ifd_ref);
  return (copy);
}

static inline int pack_timage(Timage *timage)
{ _Timage *object  = (_Timage *) (((char *) timage) - Timage_Offset);
  if (object->csize > timage_csize(timage))
    { int ns = timage_csize(timage);
      if (ns != 0)
        { void *x = Guarded_Realloc(timage->channels,(size_t) ns,"Pack_Timage");
          if (x == NULL) return (1);
          timage->channels = x;
        }
      else
        { free(timage->channels);
          timage->channels = NULL;
        }
      object->csize = ns;
    }
  if (object->msize > timage_msize(timage))
    { int ns = timage_msize(timage);
      if (ns != 0)
        { void *x = Guarded_Realloc(timage->map,(size_t) ns,"Pack_Timage");
          if (x == NULL) return (1);
          timage->map = x;
        }
      else
...
Tiff_Image *Inc_Tiff_Image(Tiff_Image *tiff_image)
{ _Timage *object  = (_Timage *) (((char *) tiff_image) - Timage_Offset);
  pthread_mutex_lock(&Timage_Mutex);
  object->refcnt += 1;
  pthread_mutex_unlock(&Timage_Mutex);
...
static inline void free_timage(Timage *timage)
{ _Timage *object  = (_Timage *) (((char *) timage) - Timage_Offset);
  pthread_mutex_lock(&Timage_Mutex);
  if (--object->refcnt > 0)
    { pthread_mutex_unlock(&Timage_Mutex);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Freeing previously released Tiff_Image\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Timage_List = object->next;
  if (object->next != NULL)
    object->next->prev = object->prev;
  object->next = Free_Timage_List;
  Free_Timage_List = object;
  Timage_Inuse -= 1;
  pthread_mutex_unlock(&Timage_Mutex);
  if (timage->ifd_ref != NULL)
    { Free_Tiff_IFD(timage->ifd_ref);
      timage->ifd_ref = NULL;
    }
}
...
{ _Timage *object  = (_Timage *) (((char *) timage) - Timage_Offset);
  ...
  if (object->refcnt < 0)
    fprintf(stderr,"Warning: Killing previously released Tiff_Image\n");
  if (object->prev != NULL)
    object->prev->next = object->next;
  else
    Use_Timage_List = object->next;
  ...
  pthread_mutex_unlock(&Timage_Mutex);
  if (timage->ifd_ref != NULL)
    Kill_Tiff_IFD(timage->ifd_ref);
  if (timage->map != NULL)
    free(timage->map);
  if (timage->channels != NULL)
    free(timage->channels);
  free(((char *) timage) - Timage_Offset);
}

static inline void reset_timage()
{ _Timage *object;
  Timage  *timage;
  pthread_mutex_lock(&Timage_Mutex);
  while (Free_Timage_List != NULL)
    { object = Free_Timage_List;
      Free_Timage_List = object->next;
      timage = &(object->timage);
      if (timage->map != NULL)
...
{ _Timage *a, *b;
  for (a = Use_Timage_List; a != NULL; a = b)
    { b = a->next;
      handler((Tiff_Image *) &(a->timage));
    }
}
