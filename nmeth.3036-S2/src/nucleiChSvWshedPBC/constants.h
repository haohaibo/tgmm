...
typedef unsigned short int imgLabelType;//decide the format of the segmentation mask
static const  uint64 maxNumLabels = 65535;//maximum number of labels. Label = 0 is always reserved for background
