...
struct quat_product<Architecture::SSE, Derived, OtherDerived, float, Aligned> {
  inline static Quaternion<float> run(const QuaternionBase<Derived>& _a,
...
struct cross3_impl<Architecture::SSE, VectorLhs, VectorRhs, float, true> {
  inline static typename plain_matrix_type<VectorLhs>::type run(
...
struct quat_product<Architecture::SSE, Derived, OtherDerived, double, Aligned> {
  inline static Quaternion<double> run(const QuaternionBase<Derived>& _a,
                                       const QuaternionBase<OtherDerived>& _b) {
    const Packet2d mask =
