...
struct rotation_base_generic_product_selector<
  ...
  inline static ReturnType run(const RotationDerived& r,
...
struct rotation_base_generic_product_selector<RotationDerived, OtherVectorType,
  ...
  EIGEN_STRONG_INLINE static ReturnType run(const RotationDerived& r,
...
inline static Matrix<Scalar, Dim, Dim> toRotationMatrix(
    const RotationBase<OtherDerived, Dim>& r) {
  return r.toRotationMatrix();
}

template <typename Scalar, int Dim, typename OtherDerived>
inline static const MatrixBase<OtherDerived>& toRotationMatrix(
