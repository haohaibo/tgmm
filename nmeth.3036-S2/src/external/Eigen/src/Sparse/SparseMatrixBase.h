...
class SparseMatrixBase : public EigenBase<Derived> {
 public:
  ...
  //                         const
  //                         SparseCwiseUnaryOp<internal::scalar_conjugate_op<Scalar>,
  //                         Derived>,
  //                         const Derived&
  //                      >::type ConjugateReturnType;
  /* \internal the return type of MatrixBase::real() */
  //     typedef SparseCwiseUnaryOp<internal::scalar_real_op<Scalar>, Derived>
  //     RealReturnType;
  /* \internal the return type of MatrixBase::imag() */
  //     typedef SparseCwiseUnaryOp<internal::scalar_imag_op<Scalar>, Derived>
  //     ImagReturnType;
...
#undef EIGEN_CURRENT_STORAGE_BASE_CLASS
  ...
  inline void assignGeneric(const OtherDerived& other) {
    //       std::cout << "Derived& operator=(const MatrixBase<OtherDerived>&
    //       other)\n";
  ...
  //     const SparseCwiseUnaryOp<internal::scalar_opposite_op<typename
  //     internal::traits<Derived>::Scalar>,Derived> operator-() const;
  ...
  //     template<typename OtherDerived>
  //     const CwiseBinaryOp<internal::scalar_difference_op<typename
  //     internal::traits<Derived>::Scalar>, Derived, OtherDerived>
  //     operator-(const SparseMatrixBase<OtherDerived> &other) const;
  ...
  //     Flagged<Product<Lhs,Rhs,CacheFriendlyProduct>, 0, EvalBeforeNestingBit
...
#define EIGEN_SPARSE_CWISE_PRODUCT_RETURN_TYPE                              \
  ...
  //     const SparseCwiseUnaryOp<internal::scalar_multiple_op<typename
  //     internal::traits<Derived>::Scalar>, Derived>
  //     operator*(const Scalar& scalar) const;
  //     const SparseCwiseUnaryOp<internal::scalar_quotient1_op<typename
  //     internal::traits<Derived>::Scalar>, Derived>
  //     operator/(const Scalar& scalar) const;

  //     inline friend const
  //     SparseCwiseUnaryOp<internal::scalar_multiple_op<typename
  //     internal::traits<Derived>::Scalar>, Derived>
...
//     void solveTriangularInPlace(SparseMatrixBase<OtherDerived>& other) const;
  ...
  SparseInnerVectorSet<Derived, Dynamic> innerVectors(Index outerStart,
                                                      Index outerSize);
  const SparseInnerVectorSet<Derived, Dynamic> innerVectors(
      Index outerStart, Index outerSize) const;

  //     typename BlockReturnType<Derived>::Type block(int startRow, int
  //     startCol, int blockRows, int blockCols);
  //     const typename BlockReturnType<Derived>::Type
  //     block(int startRow, int startCol, int blockRows, int blockCols) const;
  //
  //     typename BlockReturnType<Derived>::SubVectorType segment(int start, int
  //     size);
  //     const typename BlockReturnType<Derived>::SubVectorType segment(int
  //     start, int size) const;
  //
  //     typename BlockReturnType<Derived,Dynamic>::SubVectorType start(int
  //     size);
  //     const typename BlockReturnType<Derived,Dynamic>::SubVectorType
  //     start(int size) const;
  //
  //     typename BlockReturnType<Derived,Dynamic>::SubVectorType end(int size);
  //     const typename BlockReturnType<Derived,Dynamic>::SubVectorType end(int
  //     size) const;
  //
  //     template<int BlockRows, int BlockCols>
  //     typename BlockReturnType<Derived, BlockRows, BlockCols>::Type block(int
  //     startRow, int startCol);
  //     template<int BlockRows, int BlockCols>
  //     const typename BlockReturnType<Derived, BlockRows, BlockCols>::Type
  //     block(int startRow, int startCol) const;

  //     template<int Size> typename
  //     BlockReturnType<Derived,Size>::SubVectorType start(void);
  //     template<int Size> const typename
  //     BlockReturnType<Derived,Size>::SubVectorType start() const;

  //     template<int Size> typename
  //     BlockReturnType<Derived,Size>::SubVectorType end();
  //     template<int Size> const typename
  //     BlockReturnType<Derived,Size>::SubVectorType end() const;

  //     template<int Size> typename
  //     BlockReturnType<Derived,Size>::SubVectorType segment(int start);
  //     template<int Size> const typename
  //     BlockReturnType<Derived,Size>::SubVectorType segment(int start) const;
  ...
  //     static const ConstantReturnType Constant(int rows, int cols, const
  //     Scalar& value);
  //     static const ConstantReturnType Constant(int size, const Scalar&
  //     value);
  //     static const ConstantReturnType Constant(const Scalar& value);

  //     template<typename CustomNullaryOp>
  //     static const CwiseNullaryOp<CustomNullaryOp, Derived> NullaryExpr(int
  //     rows, int cols, const CustomNullaryOp& func);
  //     template<typename CustomNullaryOp>
  //     static const CwiseNullaryOp<CustomNullaryOp, Derived> NullaryExpr(int
  //     size, const CustomNullaryOp& func);
  //     template<typename CustomNullaryOp>
  //     static const CwiseNullaryOp<CustomNullaryOp, Derived> NullaryExpr(const
  ...
  //     bool isApproxToConstant(const Scalar& value, RealScalar prec =
  //     NumTraits<Scalar>::dummy_precision()) const;
  //     bool isZero(RealScalar prec = NumTraits<Scalar>::dummy_precision())
  //     const;
  //     bool isOnes(RealScalar prec = NumTraits<Scalar>::dummy_precision())
  //     const;
  ...
  //     bool isUpper(RealScalar prec = NumTraits<Scalar>::dummy_precision())
  //     const;
  //     bool isLower(RealScalar prec = NumTraits<Scalar>::dummy_precision())
  //     const;
  ...
  //     const SparseCwiseUnaryOp<internal::scalar_cast_op<typename
  //     internal::traits<Derived>::Scalar, NewType>, Derived> cast() const;
  ...
  //     const Flagged<Derived, 0, EvalBeforeNestingBit |
  //     EvalBeforeAssigningBit> lazy() const;

  /** \returns number of elements to skip to pass from one row (resp. column) to
   * another
    * for a row-major (resp. column-major) matrix.
    * Combined with coeffRef() and the \ref flags flags, it allows a direct
   * access to the data
  ...
  //     const SparseCwiseUnaryOp<CustomUnaryOp, Derived> unaryExpr(const
  ...
  //     typename internal::traits<Derived>::Scalar minCoeff(int* row, int* col
  //     = 0) const;
  //     typename internal::traits<Derived>::Scalar maxCoeff(int* row, int* col
  //     = 0) const;

  //     template<typename BinaryOp>
  //     typename internal::result_of<BinaryOp(typename
  //     internal::traits<Derived>::Scalar)>::type
  ...
  inline const Select<Derived,ThenDerived, typename
  ThenDerived::ConstantReturnType>
  select(const MatrixBase<ThenDerived>& thenMatrix, typename ThenDerived::Scalar
  elseScalar) const;

  template<typename ElseDerived>
  inline const Select<Derived, typename ElseDerived::ConstantReturnType,
  ElseDerived >
  select(typename ElseDerived::Scalar thenScalar, const MatrixBase<ElseDerived>&
  elseMatrix) const;
  ...
  */
  ...
  //       EIGEN_STATIC_ASSERT((internal::is_same<Scalar, typename
  ...
  //       // return res = (derived().cwise() *
  //       other.derived().conjugate()).sum();
  //
