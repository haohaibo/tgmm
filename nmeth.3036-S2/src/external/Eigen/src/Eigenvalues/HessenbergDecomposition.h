...
class HessenbergDecomposition {
 public:
  ...
  typedef typename HouseholderSequence<
      MatrixType, CoeffVectorType>::ConjugateReturnType HouseholderSequenceType;
  ...
  for (Index i = 0; i < n - 1; ++i) {
    ...
    matA.rightCols(remainingSize)
        .applyHouseholderOnTheRight(
            matA.col(i).tail(remainingSize - 1).conjugate(), internal::conj(h),
            &temp.coeffRef(0));
  }
}
