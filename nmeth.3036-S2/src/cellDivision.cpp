...
//=============================================================================================================
int cellDivisionMinFlowTouchingSupervoxels(lineageHyperTree& lht, int TM, int conn3D, size_t minNeighboringVoxels, int &numCellDivisions, int &numBirths)
{
	numCellDivisions = 0;
	numBirths = 0;
...
//=============================================================================================================
int cellDivisionMinFlowTouchingSupervoxels(lineageHyperTree& lht, int TM, int conn3D, size_t minNeighboringVoxels, int &numCellDivisions)
{
	numCellDivisions = 0;
...
int backgroundCheckWithClassifierShortLineages(lineageHyperTree& lht, int TM, int maxLengthBackgroundCheck, const imageType* imgPtr, const long long int *imgDims )
{
	...
	for(int jj = 0; jj<numEllipsoids; jj++)
	{
		...
		vecSiter[jj]->weightedGaussianStatistics<float>(mAux,Waux, &I, true);//calculate equivalence
