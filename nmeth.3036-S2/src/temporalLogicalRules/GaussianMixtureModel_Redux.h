...
class GaussianMixtureModelRedux {
 public:
  ...
  double beta_k;  // proportionality constant to relate covariance matrix of the
                  ...
                  // covariance itself
  double W_k[dimsImage * dimsImage];  // expected value of the covariance of the
                                      // Gaussian. It should be a symmetric
                                      // matrix
  ...
  double beta_o;  // proportionality constant to relate covariance matrix of the
                  // mean of the Gaussian and and the expected value of teh
                  // covariance itself
  double W_o[dimsImage * dimsImage];  // expected value of the covariance of the
                                      // Gaussian. It should be a symmetric
                                      // matrix
...
int readGaussianMixtureModelXMLfile(string filename,
