...
int supervoxel::weightedGaussianStatistics(double* m, double *W, float* intensity, bool regularizeW)
{
...
//=====================================================================
template<class imgTypeC>
int supervoxel::robustGaussianStatistics(double*m, double* W, int maxSize, float maxPercentile)
{
	...
	float I;
	sv.weightedGaussianStatistics<imgTypeC>(m, W, &I, false);//we should not need to regularize
}

//====================================================================
template<class imgTypeC>
imgTypeC supervoxel::intensityThreshold(int maxSize, float maxPercentile, unsigned int *maxPosPixelIdxList, bool localBackgroundSubtracted)
{
...
//====================================================================
template<class imgTypeC>
imgTypeC supervoxel::trimSupervoxel(int maxSize, float maxPercentile,int conn3D, int64* neighOffset)
{
	...
	//calculate threshold	
	thr = intensityThreshold<imgTypeC>(maxSize, maxPercentile, &maxPosPixelIdxList, localBackgroundSubtracted);
...
template float supervoxel::trimSupervoxel<float>(int maxSize, float maxPercentile, int conn3D, int64* neighOffset);
template unsigned short int supervoxel::trimSupervoxel<unsigned short int>(int maxSize, float maxPercentile, int conn3D, int64* neighOffset);
template unsigned char supervoxel::trimSupervoxel<unsigned char>(int maxSize, float maxPercentile, int conn3D, int64* neighOffset);
...
template float supervoxel::intensityThreshold<float>(int maxSize, float maxPercentile, unsigned int *maxPosPixelIdxList, bool localBackgroundSubtracted);
template unsigned short int supervoxel::intensityThreshold<unsigned short int>(int maxSize, float maxPercentile, unsigned int *maxPosPixelIdxList, bool localBackgroundSubtracted);
template unsigned char supervoxel::intensityThreshold<unsigned char>(int maxSize, float maxPercentile, unsigned int *maxPosPixelIdxList, bool localBackgroundSubtracted);

template int supervoxel::weightedGaussianStatistics<float>(double*m, double* W,float* intensity, bool regularizeW);
template int supervoxel::weightedGaussianStatistics<unsigned short int>(double*m, double* W,float* intensity, bool regularizeW);
template int supervoxel::weightedGaussianStatistics<unsigned char>(double*m, double* W,float* intensity, bool regularizeW);


template int supervoxel::weightedGaussianStatistics<float>(bool regularizeW);
template int supervoxel::weightedGaussianStatistics<unsigned short int>(bool regularizeW);
template int supervoxel::weightedGaussianStatistics<unsigned char>(bool regularizeW);
...
template int supervoxel::robustGaussianStatistics<float>(double*m, double* W, int maxSize, float maxPercentile);
template int supervoxel::robustGaussianStatistics<unsigned short int>(double*m, double* W, int maxSize, float maxPercentile);
template int supervoxel::robustGaussianStatistics<unsigned char>(double*m, double* W, int maxSize, float maxPercentile);
