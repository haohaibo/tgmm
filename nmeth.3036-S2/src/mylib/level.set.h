...
void Print_Level_Tree(Level_Tree *t, int indent, int idwidth, int valwidth,
                      FILE *file);
...
typedef void
    Level_Set;  // Vertex of level set tree (corresponds to a level set);
...
void List_Level_Set(Level_Tree *t, Level_Set *r, void *arg,
