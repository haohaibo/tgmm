...
typedef struct { double w, h; } SVG_Box;
...
SVG_Path *Append_Bezier(SVG_Path *R(M(path)), SVG_Point *C(in),
                        SVG_Point *C(out), SVG_Point *C(pnt));
SVG_Path *Append_Arc(SVG_Path *R(M(path)), SVG_Point *C(rad), double xrot,
                     boolean large_arc, boolean cc_sweep, SVG_Point *C(pnt));
...
// An SVG_Canvas object is unusual in that it does not have Copy, Free, Kill,
// Reset, or
//   Usage routines.  You can simply create one with Begin_SVG_Drawing and then
//   later
//   kill/destroy it with Finish_SVG_Drawing.  Begin_SVG_Drawing returns NULL if
//   it
...
SVG_Canvas *G(Begin_SVG_Drawing)(string file_name, SVG_Box *F(viewport),
                                 SVG_Frame *F(viewbox));
...
typedef enum {
  ...
  SVG_chocolate = 15,
  SVG_coral = 16,
  SVG_cornflower_blue = 17,
  SVG_cornsilk = 18,
  SVG_crimson = 19,
  SVG_cyan = 20,
  SVG_dark_blue = 21,
  SVG_dark_cyan = 22,
  SVG_dark_goldenrod = 23,
  SVG_dark_gray = 24,
  SVG_dark_green = 25,
  SVG_dark_grey = 26,
  SVG_dark_khaki = 27,
  SVG_dark_magenta = 28,
  SVG_dark_olive_green = 29,
  SVG_dark_orange = 30,
  SVG_dark_orchid = 31,
  SVG_dark_red = 32,
  SVG_dark_salmon = 33,
  SVG_dark_sea_green = 34,
  SVG_dark_slate_blue = 35,
  SVG_dark_slate_gray = 36,
  SVG_dark_slate_grey = 37,
  SVG_dark_turquoise = 38,
  SVG_dark_violet = 39,
  SVG_deep_pink = 40,
  SVG_deep_sky_blue = 41,
  SVG_dim_gray = 42,
  SVG_dim_grey = 43,
  SVG_dodger_blue = 44,
  SVG_fire_brick = 45,
  ...
  SVG_khaki = 62,
  SVG_lavender = 63,
  SVG_lavender_blush = 64,
  SVG_lawn_green = 65,
  SVG_lemon_chiffon = 66,
  SVG_light_blue = 67,
  SVG_light_coral = 68,
  SVG_light_cyan = 69,
  SVG_light_goldenrod_yellow = 70,
  SVG_light_gray = 71,
  SVG_light_green = 72,
  SVG_light_grey = 73,
  SVG_light_pink = 74,
  SVG_light_salmon = 75,
  SVG_light_sea_green = 76,
  SVG_light_sky_blue = 77,
  SVG_light_slate_gray = 78,
  SVG_light_slate_grey = 79,
  SVG_light_steel_blue = 80,
  SVG_light_yellow = 81,
  SVG_lime = 82,
  SVG_lime_green = 83,
  SVG_linen = 84,
  SVG_magenta = 85,
  SVG_maroon = 86,
  SVG_medium_aquamarine = 87,
  SVG_medium_blue = 88,
  SVG_medium_orchid = 89,
  SVG_medium_purple = 90,
  SVG_medium_sea_green = 91,
  SVG_medium_slate_blue = 92,
  SVG_medium_spring_green = 93,
  SVG_medium_turquoise = 94,
  SVG_medium_violet_red = 95,
  SVG_midnight_blue = 96,
  SVG_mint_cream = 97,
  SVG_misty_rose = 98,
  SVG_moccasin = 99,
  SVG_navajo_white = 100,
  SVG_navy = 101,
  SVG_old_lace = 102,
  SVG_olive = 103,
  SVG_olive_drab = 104,
  ...
  SVG_orange_red = 106,
  SVG_orchid = 107,
  SVG_pale_goldenrod = 108,
  SVG_pale_green = 109,
  SVG_pale_turquoise = 110,
  SVG_pale_violet_red = 111,
  SVG_papaya_whip = 112,
  SVG_peach_puff = 113,
  SVG_peru = 114,
  SVG_pink = 115,
...
void SVG_Stroke_Color(SVG_Context *M(context),
                      SVG_Color color);  // default is SVG_black
...
void SVG_Stroke_Opacity(SVG_Context *M(context),
                        double pcnt);  // default is 1.0

void SVG_Join_Style(SVG_Context *M(context),
                    SVG_Join style);  // default is SVG_miter_join
void SVG_Cap_Style(SVG_Context *M(context),
                   SVG_Cap style);  // default is SVG_square_cap
void SVG_Miter_Limit(SVG_Context *M(context), double limit);  // default is 4.0

void SVG_Dash_Spec(SVG_Context *M(context), double offset, int n,
                   double *dashlens);

void SVG_Fill_Off(SVG_Context *M(context));
void SVG_Fill_Color(SVG_Context *M(context),
                    SVG_Color color);  // default is off
void SVG_Fill_RGB(SVG_Context *M(context), int red, int green, int blue);
void SVG_Fill_Opacity(SVG_Context *M(context),
                      double pcnt);  // default is 0.0 (no fill)
...
void SVG_Rectangle(SVG_Canvas *canvas, SVG_Frame *F(rectangle),
                   double roundness);
...
void SVG_Ellipse(SVG_Canvas *canvas, SVG_Point *F(center), SVG_Point *F(radii),
                 double angle);
