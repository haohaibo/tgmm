...
void Flood_Object(APart *source, int share, boolean iscon2n, Indx_Type seed,
                  ...
                  void *arge, void (*eval)(Indx_Type p, void *arge), void *argc,
                  boolean (*check)(Size_Type n, void *argc), void *arga,
                  void (*act)(Indx_Type p, void *arga));

void Flood_All(APart *source, int share, boolean iscon2n, void *argt,
               boolean (*test)(Indx_Type p, void *argt), void *arge,
               void (*eval)(Indx_Type p, void *arge), void *argc,
               boolean (*check)(Size_Type n, void *argc), void *arga,
               void (*act)(Indx_Type p, void *arga));

void Flood_Surface(APart *source, int share, boolean iscon2n,
                   Indx_Type leftmost_seed, void *argt,
                   boolean (*test)(Indx_Type p, void *argt), void *arge,
                   void (*eval)(Indx_Type p, void *arge), void *argc,
                   boolean (*check)(Size_Type n, Size_Type a, Size_Type d,
                                    void *argc),
                   void *arga, void (*act)(Indx_Type p, int x, void *arga));

Indx_Type Find_Leftmost_Seed(APart *source, int share, boolean iscon2n,
                             Indx_Type seed, void *argt,
                             int (*test)(Indx_Type p, void *argt));
